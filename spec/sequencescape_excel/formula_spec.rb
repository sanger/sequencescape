...
RSpec.describe SequencescapeExcel::Download, type: :model, sample_manifest_excel: true do
  ...
  it 'should be comparable' do
    ...
    expect(SequencescapeExcel::Formula.new(options.except(:operand).merge(references.slice(:first_cell_reference)))).to_not eq(formula)
  end
end
