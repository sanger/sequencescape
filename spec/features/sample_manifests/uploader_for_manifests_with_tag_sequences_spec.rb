...
describe 'Sample manifest with tag sequences', :js, :sample_manifest do
  before(:all) do
    ...
    context 'valid' do
      context 'upload and reupload' do
        ...
        it 'with override' do
          ...
          expect(
            download.worksheet.multiplexed_library_tube.aliquots.count { |a| a.library_type == new_library_type_name }
          ).to eq 2
        end
      end
