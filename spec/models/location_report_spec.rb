...
RSpec.describe LocationReport, type: :model do
  ...
  context 'when no report type is set' do
    # let(:location_report) { create :location_report_selection, barcodes_text: '1234567890123' }
  ...
  context 'when testing report generation' do
    ...
    #     context 'when selecting by dates and faculty sponsor' do
    #       let(:start_date) { '2016-01-01 00:00:00' }
    ...
    #     context 'when selecting by dates and multiple faculty sponsors' do
    #       let(:start_date) { '2016-01-01 00:00:00' }
    #       let(:end_date) { '2016-11-01 00:00:00' }
