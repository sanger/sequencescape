...
describe Well do
  ...
  context 'to be cherrypicked' do
    ...
    [
      ...
      [100.0, 5.0, 100.0, 2.0, 5.0, 5.0, 95.0, 'Less DNA than robot minimum pick, fall back to DNA'],
      ...
      [120.0, 50.0, 0, 3.0, 5.0, 5.0, 115.0, 'Zero concentration, with less volume than even the minimum robot pick']
