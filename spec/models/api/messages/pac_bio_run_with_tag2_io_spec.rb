...
RSpec.describe Api::Messages::PacBioRunWithTag2Io do
          ...
          'samples' => [
            {
              ...
              'tag2_sequence' => aliquot_1.tag2.oligo,
              'tag2_set_id_lims' => aliquot_1.tag2.tag_group_id,
              'tag2_identifier' => aliquot_1.tag2.map_id,
              'tag2_set_name' => aliquot_1.tag2.tag_group.name
            }
          ]
        },
        {
