...
RSpec.describe Api::PacBioLibraryTubeIO, type: :model do
  subject do
    create :pac_bio_library_tube, :scanned_into_lab, concentration: 8.0, volume: 12.0, pac_bio_library_tube_metadata_attributes: {
