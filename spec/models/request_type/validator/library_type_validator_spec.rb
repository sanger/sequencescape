    ...
    context 'when a default library type is set' do
      before do
        request_type.library_types_request_types <<
          create(:library_types_request_type, library_type:, request_type:, is_default: false)
        request_type.library_types_request_types <<
          create(:library_types_request_type, library_type: library_type2, request_type:, is_default: true)
      end
