      ...
      context 'quadrants' do
            ...
            let(:expected_tag_layout) do
              {
                'A1' => [1], 'A2' => [1], 'A3' => [9],  'A4' => [9],
                'B1' => [1], 'B2' => [1], 'B3' => [9],  'B4' => [9],
                'C1' => [2], 'C2' => [2], 'C3' => [10], 'C4' => [10],
                'D1' => [2], 'D2' => [2], 'D3' => [10], 'D4' => [10],
                'E1' => [3], 'E2' => [3], 'E3' => [11], 'E4' => [11],
                'F1' => [3], 'F2' => [3], 'F3' => [11], 'F4' => [11],
                'G1' => [4], 'G2' => [4], 'G3' => [12], 'G4' => [12],
                'H1' => [4], 'H2' => [4], 'H3' => [12], 'H4' => [12],
                'I1' => [5], 'I2' => [5], 'I3' => [13], 'I4' => [13],
                'J1' => [5], 'J2' => [5], 'J3' => [13], 'J4' => [13],
                'K1' => [6], 'K2' => [6], 'K3' => [14], 'K4' => [14],
                'L1' => [6], 'L2' => [6], 'L3' => [14], 'L4' => [14],
                'M1' => [7], 'M2' => [7], 'M3' => [15], 'M4' => [15],
                'N1' => [7], 'N2' => [7], 'N3' => [15], 'N4' => [15],
                'O1' => [8], 'O2' => [8], 'O3' => [16], 'O4' => [16],
                'P1' => [8], 'P2' => [8], 'P3' => [16], 'P4' => [16]
              }
            end
            let(:expected_tag2_layout) do
              {
        ...
        context 'with inverse column directions' do
          ...
          context 'with a 384 well plate' do
            ...
            let(:expected_tag_layout) do
              {
                'A1' => [96], 'A2' => [96], 'A3' => [88], 'A4' => [88],
                'B1' => [96], 'B2' => [96], 'B3' => [88], 'B4' => [88],
                'C1' => [95], 'C2' => [95], 'C3' => [87], 'C4' => [87],
                'D1' => [95], 'D2' => [95], 'D3' => [87], 'D4' => [87],
                'E1' => [94], 'E2' => [94], 'E3' => [86], 'E4' => [86],
                'F1' => [94], 'F2' => [94], 'F3' => [86], 'F4' => [86],
                'G1' => [93], 'G2' => [93], 'G3' => [85], 'G4' => [85],
                'H1' => [93], 'H2' => [93], 'H3' => [85], 'H4' => [85],
                'I1' => [92], 'I2' => [92], 'I3' => [84], 'I4' => [84],
                'J1' => [92], 'J2' => [92], 'J3' => [84], 'J4' => [84],
                'K1' => [91], 'K2' => [91], 'K3' => [83], 'K4' => [83],
                'L1' => [91], 'L2' => [91], 'L3' => [83], 'L4' => [83],
                'M1' => [90], 'M2' => [90], 'M3' => [82], 'M4' => [82],
                'N1' => [90], 'N2' => [90], 'N3' => [82], 'N4' => [82],
                'O1' => [89], 'O2' => [89], 'O3' => [81], 'O4' => [81],
                'P1' => [89], 'P2' => [89], 'P3' => [81], 'P4' => [81]
              }
            end
            let(:expected_tag2_layout) do
              {
            ...
            let(:expected_tag_layout) do
              {
                'A1' => [1],  'A2' => [1],  'A3' => [2],  'A4' => [2],
                'B1' => [1],  'B2' => [1],  'B3' => [2],  'B4' => [2],
                'C1' => [13], 'C2' => [13], 'C3' => [14], 'C4' => [14],
                'D1' => [13], 'D2' => [13], 'D3' => [14], 'D4' => [14],
                'E1' => [25], 'E2' => [25], 'E3' => [26], 'E4' => [26],
                'F1' => [25], 'F2' => [25], 'F3' => [26], 'F4' => [26],
                'G1' => [37], 'G2' => [37], 'G3' => [38], 'G4' => [38],
                'H1' => [37], 'H2' => [37], 'H3' => [38], 'H4' => [38],
                'I1' => [49], 'I2' => [49], 'I3' => [50], 'I4' => [50],
                'J1' => [49], 'J2' => [49], 'J3' => [50], 'J4' => [50],
                'K1' => [61], 'K2' => [61], 'K3' => [62], 'K4' => [62],
                'L1' => [61], 'L2' => [61], 'L3' => [62], 'L4' => [62],
                'M1' => [73], 'M2' => [73], 'M3' => [74], 'M4' => [74],
                'N1' => [73], 'N2' => [73], 'N3' => [74], 'N4' => [74],
                'O1' => [85], 'O2' => [85], 'O3' => [86], 'O4' => [86],
                'P1' => [85], 'P2' => [85], 'P3' => [86], 'P4' => [86]
              }
            end
            let(:expected_tag2_layout) do
              {
