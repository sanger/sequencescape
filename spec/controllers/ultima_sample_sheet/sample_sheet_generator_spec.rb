...
RSpec.describe UltimaSampleSheet::SampleSheetGenerator do
  ...
  let(:tag_group1_name) { 'Ultima P1' }
  let(:tag_group2_name) { 'Ultima P2' }
  ...
  context 'with csv output' do
    ...
    it 'generates header sections', :aggregate_failures do
    ...
    it 'generates global section', :aggregate_failures do
    ...
    it 'generates samples section', :aggregate_failures do
    ...
    it 'matches the z-indexes, oligo sequences, and plate numbers', :aggregate_failures do
      # First CSV
