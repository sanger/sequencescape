...
FactoryBot.define do
  ...
  factory :request_base, class: Request do
    ...
    after(:build) do |request|
      ...
      request.request_metadata_attributes = attributes_for(metadata_factory) if request.request_metadata.new_record? && FactoryGirl.factories.registered?(metadata_factory)
