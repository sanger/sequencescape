...
require './app/resources/api/v2/tube_from_plate_creation_resource'

RSpec.describe Api::V2::TubeFromPlateCreationResource, type: :resource do
  subject(:resource) { described_class.new(resource_model, {}) }

  let(:resource_model) { build_stubbed(:tube_from_plate_creation) }

  # Model Name
  it { is_expected.to have_model_name 'TubeFromPlateCreation' }
