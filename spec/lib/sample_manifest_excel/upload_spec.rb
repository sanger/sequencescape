...
RSpec.describe SampleManifestExcel::Upload, type: :model, sample_manifest_excel: true do
  ...
  it 'column list is valid' do
    expect(column_list).to be_valid
  end

  it 'should be valid if all of the headings relate to a column' do
    upload = SampleManifestExcel::Upload.new("#{Rails.root}/spec/data/sample_manifest_excel/tube_library.csv")
