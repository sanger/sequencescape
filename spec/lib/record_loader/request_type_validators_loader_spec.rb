...
RSpec.describe RecordLoader::RequestTypeValidatorsLoader, type: :model, loader: true do
  ...
  context 'with two_entry_example selected' do
    ...
    it 'creates two records' do
      expect { record_loader.create! }.to change { RequestTypeValidators.count }.by(2)
    end
    ...
    it 'is idempotent' do
      ...
      expect { record_loader.create! }.not_to change { RequestTypeValidators.count }
    end
