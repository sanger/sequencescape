module SampleManifestExcel
  class Download
    ...
    def initialize(sample_manifest, column_list, range_list)
      ...
      @ranges_worksheet = SampleManifestExcel::Worksheet.new(ranges: ranges, axlsx_worksheet: ranges_axlsx_worksheet)
      ranges_worksheet.add_ranges.protect(password)
      ranges.set_absolute_references(ranges_worksheet)
      @data_worksheet = SampleManifestExcel::Worksheet.new(axlsx_worksheet: data_axlsx_worksheet, columns: column_list, sample_manifest: sample_manifest, styles: styles, ranges: ranges)
      data_worksheet.create_data_worksheet.protect(password)
    end
