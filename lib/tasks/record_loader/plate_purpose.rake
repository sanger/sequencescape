...
namespace :record_loader do
  desc 'Automatically generate PlatePurpose through PlatePurposeLoader'
  task plate_purpose: :environment do
...
task 'record_loader:all' => 'record_loader:plate_purpose'
