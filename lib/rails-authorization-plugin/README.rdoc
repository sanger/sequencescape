WARNING: WE have an intent to remove this as a dependency, so please do not
build any further dependence on it.
...
into your Rails.root/vendor/plugins/rails-authorization-plugin directory.
...
you can stuff that directory in your Rails.root/vendor/plugins directory.
