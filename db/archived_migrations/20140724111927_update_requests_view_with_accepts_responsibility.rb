...
class UpdateRequestsViewWithAcceptsResponsibility < ActiveRecord::Migration
  def self.up
    ActiveRecord::Base.transaction do
      ViewsSchema.update_view(
        'view_requests',%Q{
          CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `view_requests`
AS SELECT
