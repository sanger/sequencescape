class AddChromiumRequestType < ActiveRecord::Migration
  def up
    ActiveRecord::Base.transaction do
      ...
      RequestType.find_by_key('illumina_c_multiplexing').acceptable_plate_purposes << Purpose.find_by_name!('ILC Lib Chromium')
  ...
  def down
    ActiveRecord::Base.transaction do
      RequestType.find_by_key('illumina_c_chromium_library').destroy
    end
  end
end
