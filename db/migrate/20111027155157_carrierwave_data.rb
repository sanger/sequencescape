      ...
      SampleManifest.find_each(:batch_size => 200) do |s|
        ...
        unless s.uploaded_file.nil?
          ...
          begin
            ...
            Document.create!(:uploaded_data => uploaded,  :documentable_type => 'SampleManifest', :documentable_id=> s.id, :documentable_extended => "uploaded" )
          ensure
            uploaded.close
        ...
        unless s.generated_file.nil?
          ...
          begin
            ...
            Document.create!(:uploaded_data => generated, :documentable_type => 'SampleManifest', :documentable_extended => "generated")
          ensure
            generated.close
