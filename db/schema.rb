...
ActiveRecord::Schema.define(version: 2021_05_04_153704) do
  ...
  create_table 'aliquot_indices',
    ...
    t.index %w[lane_id aliquot_index], name: 'index_aliquot_indices_on_lane_id_and_aliquot_index', unique: true
  end

  create_table 'aliquots',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    ...
    t.index %w[receptacle_id tag_id tag2_id], name: 'aliquot_tags_and_tag2s_are_unique_within_receptacle', unique: true
    t.index ['request_id'], name: 'fk_rails_37734e1810'
    t.index ['sample_id'], name: 'index_aliquots_on_sample_id'
    t.index %w[study_id receptacle_id], name: 'index_aliquots_on_study_id_and_receptacle_id'
    t.index ['study_id'], name: 'index_aliquots_on_study_id'
    t.index ['tag_id'], name: 'tag_id_idx'
  end

  create_table 'api_applications',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
  ...
  create_table 'asset_barcodes',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
  end

  create_table 'asset_creation_parents',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
  ...
  create_table 'asset_group_assets',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.integer 'asset_id'
  ...
  create_table 'asset_links',
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[ancestor_id direct], name: 'index_asset_links_on_ancestor_id_and_direct'
    t.index %w[descendant_id direct], name: 'index_asset_links_on_descendant_id_and_direct'
  end

  create_table 'asset_shapes',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.string 'name', null: false
  ...
  create_table 'assets_deprecated',
               id: :integer,
    ...
    t.index %w[sti_type plate_purpose_id], name: 'index_assets_on_plate_purpose_id_sti_type'
    t.index %w[sti_type updated_at], name: 'index_assets_deprecated_on_sti_type_and_updated_at'
    t.index ['sti_type'], name: 'index_assets_deprecated_on_sti_type'
    t.index ['updated_at'], name: 'index_assets_deprecated_on_updated_at'
  end

  create_table 'bait_libraries',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    ...
    t.index %w[bait_library_supplier_id name], name: 'bait_library_names_are_unique_within_a_supplier', unique: true
  end

  create_table 'bait_library_layouts',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.integer 'user_id'
  ...
  create_table 'bait_library_suppliers',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.string 'name', null: false
  ...
  create_table 'bait_library_types',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.string 'name', null: false
  ...
  create_table 'barcode_printer_types',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.string 'name'
  ...
  create_table 'batches',
    ...
    t.string 'barcode'
    t.index %w[pipeline_id state created_at], name: 'index_batches_on_pipeline_id_and_state_and_created_at'
    t.index ['updated_at'], name: 'index_batches_on_updated_at'
  end

  create_table 'broadcast_events',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.string 'sti_type'
    ...
    t.integer 'seed_id'
    t.integer 'user_id'
    t.text 'properties', limit: 16_777_215
    t.datetime 'created_at'
    t.datetime 'updated_at'
  end

  create_table 'budget_divisions',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.string 'name'
  ...
  create_table 'container_associations_deprecated',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=latin1',
               force: :cascade do |t|
  ...
  create_table 'custom_metadatum_collections',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.integer 'user_id'
  ...
  create_table 'data_release_study_types',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.string 'name'
  ...
  create_table 'db_files',
               ...
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.binary 'data', limit: 4_294_967_295
    t.integer 'owner_id'
    t.string 'owner_type', limit: 25, default: 'Document', null: false
    t.string 'owner_type_extended'
    t.index %w[owner_type owner_id], name: 'index_db_files_on_owner_type_and_owner_id'
  end
  ...
  create_table 'delayed_jobs',
    ...
    t.text 'handler', limit: 16_777_215
    t.text 'last_error', limit: 16_777_215
    t.datetime 'run_at'
  ...
  create_table 'descriptors',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.string 'name'
    t.string 'value'
    t.text 'selection', limit: 16_777_215
    t.integer 'task_id'
    t.string 'kind'
    t.boolean 'required'
    t.integer 'sorter'
  ...
  create_table 'documents',
    ...
    t.index %w[documentable_id documentable_type], name: 'index_documents_on_documentable_id_and_documentable_type'
  ...
  create_table 'extended_validators',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.string 'behaviour', null: false
    t.text 'options', limit: 16_777_215
    t.datetime 'created_at'
    t.datetime 'updated_at'
  end

  create_table 'external_properties',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    ...
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.index %w[propertied_id propertied_type key], name: 'ep_pi_pt_key'
  end

  create_table 'extraction_attributes',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.integer 'target_id'
    t.string 'created_by'
    t.text 'attributes_update', limit: 4_294_967_295
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
  end

  create_table 'faculty_sponsors',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.string 'name'
  ...
  create_table 'failures',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.integer 'failable_id'
    t.string 'failable_type', limit: 50
    t.text 'reason', limit: 16_777_215
    t.boolean 'notify_remote'
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.text 'comment', limit: 16_777_215
  ...
  create_table 'identifiers',
    ...
    t.index %w[external_id identifiable_id], name: 'index_identifiers_on_external_id_and_identifiable_id'
    t.index ['external_type'], name: 'index_identifiers_on_external_type'
    t.index %w[identifiable_id identifiable_type], name: 'index_identifiers_on_identifiable_id_and_identifiable_type'
    t.index ['resource_name'], name: 'index_identifiers_on_resource_name'
  end

  create_table 'implements',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.string 'name'
  ...
  create_table 'lab_events',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.text 'description', limit: 16_777_215
    t.text 'descriptors', limit: 16_777_215
    t.text 'descriptor_fields', limit: 16_777_215
    t.integer 'eventful_id'
    t.string 'eventful_type', limit: 50
    t.datetime 'created_at'
    t.datetime 'updated_at'
  ...
  create_table 'labware',
    ...
    t.index %w[sti_type plate_purpose_id], name: 'index_labware_on_sti_type_and_plate_purpose_id'
    t.index %w[sti_type updated_at], name: 'index_labware_on_sti_type_and_updated_at'
    t.index ['updated_at'], name: 'index_labware_on_updated_at'
  end

  create_table 'lane_metadata',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.integer 'lane_id'
  ...
  create_table 'library_types_request_types',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
  ...
  create_table 'location_reports',
    ...
    t.text 'barcodes', limit: 16_777_215
  ...
  create_table 'lots',
    ...
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.index %w[lot_number lot_type_id], name: 'index_lot_number_lot_type_id', unique: true
  ...
  create_table 'maps',
    ...
    t.index %w[description asset_size], name: 'index_maps_on_description_and_asset_size'
    t.index ['description'], name: 'index_maps_on_description'
  end

  create_table 'messenger_creators',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
  ...
  create_table 'messengers',
    ...
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.index %w[target_id target_type], name: 'index_messengers_on_target_id_and_target_type'
  end

  create_table 'order_roles',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.string 'role'
  ...
  create_table 'orders',
    ...
    t.integer 'user_id'
    t.text 'item_options', limit: 16_777_215
    t.text 'request_types', limit: 16_777_215
    t.text 'request_options', limit: 16_777_215
    t.text 'comments', limit: 16_777_215
    t.integer 'project_id'
    t.string 'sti_type'
  ...
  create_table 'pac_bio_library_tube_metadata',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
  ...
  create_table 'pipeline_request_information_types',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.integer 'pipeline_id'
  ...
  create_table 'pipelines_request_types',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
  ...
  create_table 'plate_creator_parent_purposes',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
  ...
  create_table 'plate_creator_purposes',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.integer 'plate_creator_id', null: false
  ...
  create_table 'plate_creators',
    ...
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.text 'valid_options', limit: 16_777_215
    t.index ['name'], name: 'index_plate_creators_on_name', unique: true
  end

  create_table 'plate_metadata',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.integer 'plate_id'
  ...
  create_table 'plate_purpose_relationships',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.integer 'parent_id'
  ...
  create_table 'pooling_methods',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.string 'pooling_behaviour', limit: 50, null: false
    t.text 'pooling_options', limit: 16_777_215
  end

  create_table 'pre_capture_pool_pooled_requests',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
  ...
  create_table 'pre_capture_pools',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.datetime 'created_at'
  ...
  create_table 'primer_panels',
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.text 'programs', limit: 16_777_215
  end

  create_table 'product_catalogues',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.string 'name', null: false
  ...
  create_table 'product_criteria',
    ...
    t.text 'configuration', limit: 16_777_215
    t.datetime 'deprecated_at'
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.integer 'version'
    t.index %w[product_id stage version],
            name: 'index_product_criteria_on_product_id_and_stage_and_version',
            unique: true
  end

  create_table 'product_lines',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.string 'name', null: false
  ...
  create_table 'product_product_catalogues',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.integer 'product_id', null: false
  ...
  create_table 'qc_decision_qcables',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
  ...
  create_table 'qc_metric_requests',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
  ...
  create_table 'qc_metrics',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.integer 'qc_report_id', null: false
    t.integer 'asset_id', null: false
    t.text 'metrics', limit: 16_777_215
  ...
  create_table 'qc_reports',
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.text 'plate_purposes', limit: 16_777_215
  ...
  create_table 'receptacles',
    ...
    t.index %w[sti_type updated_at], name: 'index_receptacles_on_sti_type_and_updated_at'
    t.index ['updated_at'], name: 'index_receptacles_on_updated_at'
  end

  create_table 'reference_genomes',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.string 'name'
  ...
  create_table 'request_events',
    ...
    t.index %w[request_id current_to], name: 'index_request_events_on_request_id_and_current_to'
  end

  create_table 'request_information_types',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.string 'name'
  ...
  create_table 'request_informations',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.integer 'request_id'
  ...
  create_table 'request_type_plate_purposes',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.integer 'request_type_id', null: false
    t.integer 'plate_purpose_id', null: false
    t.index %w[request_type_id plate_purpose_id], name: 'plate_purposes_are_unique_within_request_type', unique: true
  end

  create_table 'request_type_validators',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.integer 'request_type_id', null: false
    t.string 'request_option', null: false
    t.text 'valid_options', limit: 16_777_215, null: false
    t.datetime 'created_at'
    t.datetime 'updated_at'
  end
  ...
  create_table 'request_types',
    ...
    t.text 'request_parameters', limit: 16_777_215
  ...
  create_table 'request_types_extended_validators',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.integer 'request_type_id', null: false
  ...
  create_table 'requests',
    ...
    t.index %w[initial_study_id request_type_id state],
            name: 'index_requests_on_project_id_and_request_type_id_and_state'
    t.index ['initial_study_id'], name: 'index_request_on_project_id'
    t.index %w[request_type_id state], name: 'request_type_id_state_index'
    t.index %w[state request_type_id initial_study_id], name: 'request_project_index'
  ...
  create_table 'roles',
    ...
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.index %w[authorizable_id authorizable_type], name: 'index_roles_on_authorizable_id_and_authorizable_type'
  ...
  create_table 'sample_manifest_assets',
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
  ...
  create_table 'sample_manifests',
    ...
    t.integer 'count'
    t.string 'asset_type'
    t.text 'last_errors', limit: 16_777_215
    t.string 'state'
    t.text 'barcodes', limit: 16_777_215
    t.integer 'user_id'
    t.string 'password'
  ...
  create_table 'sample_metadata',
    ...
    t.text 'sample_description', limit: 16_777_215
    t.string 'sibling'
  ...
  create_table 'sample_registrars',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.integer 'study_id'
  ...
  create_table 'sanger_sample_ids',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
  end
  ...
  create_table 'searches',
    ...
    t.text 'default_parameters', limit: 16_777_215
  end

  create_table 'specific_tube_creation_purposes',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
  ...
  create_table 'study_metadata',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.integer 'study_id'
    t.string 'old_sac_sponsor'
    t.text 'study_description', limit: 16_777_215
    t.string 'contaminated_human_dna'
    t.string 'study_project_id'
    t.text 'study_abstract', limit: 16_777_215
    ...
    t.text 'dac_policy', limit: 16_777_215
  ...
  create_table 'subclass_attributes',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.string 'name'
    ...
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.index %w[attributable_id name], name: 'index_subclass_attributes_on_attributable_id_and_name'
  end

  create_table 'submission_templates',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.string 'name'
    t.string 'submission_class_name'
    t.text 'submission_parameters', limit: 16_777_215
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.integer 'product_line_id'
    ...
    t.index %w[name superceded_by_id], name: 'name_and_superceded_by_unique_idx', unique: true
  ...
  create_table 'tag2_layout_template_submissions',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.integer 'submission_id', null: false
    ...
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.index %w[submission_id tag2_layout_template_id], name: 'tag2_layouts_used_once_per_submission', unique: true
    t.index ['tag2_layout_template_id'], name: 'fk_tag2_layout_template_submissions_to_tag2_layout_templates'
  end

  create_table 'tag2_layout_templates',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.string 'name', null: false
  ...
  create_table 'tag2_layouts',
    ...
    t.datetime 'updated_at'
    t.integer 'source_id'
    t.text 'target_well_locations', limit: 16_777_215
  end

  create_table 'tag_group_adapter_types',
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.string 'name'
    t.datetime 'created_at', null: false
  ...
  create_table 'tag_layout_template_submissions',
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.integer 'submission_id', null: false
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[submission_id tag_layout_template_id enforce_uniqueness], name: 'tag_layout_uniqueness', unique: true
  ...
  create_table 'tag_layout_templates',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
  ...
  create_table 'transfer_request_collection_transfer_requests',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
  ...
  create_table 'transfer_request_collections',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.integer 'user_id'
  ...
  create_table 'transfer_templates',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.datetime 'created_at'
  ...
  create_table 'transfers',
    ...
    t.text 'transfers_hash', limit: 16_777_215
    t.integer 'bulk_transfer_id'
    t.integer 'user_id'
    t.index ['source_id'], name: 'source_id_idx'
  end

  create_table 'tube_creation_children',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.datetime 'created_at'
  ...
  create_table 'uuids', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=latin1', force: :cascade do |t|
    ...
    t.index %w[resource_type resource_id], name: 'index_uuids_on_resource_type_and_resource_id'
  end

  create_table 'volume_updates',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.integer 'target_id'
  ...
  create_table 'well_to_tube_transfers',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
  ...
  create_table 'work_completions_submissions',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
  ...
  create_table 'work_orders',
    ...
    t.datetime 'updated_at', null: false
    t.string 'state', null: false
    t.index %w[work_order_type_id state], name: 'index_work_orders_on_work_order_type_id_and_state'
  end

  create_table 'workflow_samples',
               id: :integer,
               options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC',
               force: :cascade do |t|
    t.text 'name', limit: 16_777_215
    t.integer 'user_id'
    t.datetime 'created_at'
    t.datetime 'updated_at'
  ...
  create_table 'workflows',
    ...
    t.string 'name'
    t.integer 'item_limit'
    t.text 'locale', limit: 16_777_215
    t.integer 'pipeline_id'
  ...
  add_foreign_key 'library_types_request_types',
                  'library_types',
                  name: 'fk_library_types_request_types_to_library_types'
  add_foreign_key 'library_types_request_types',
                  'request_types',
                  name: 'fk_library_types_request_types_to_request_types'
  ...
  add_foreign_key 'messenger_creators',
                  'plate_purposes',
                  column: 'purpose_id',
                  name: 'fk_messenger_creators_to_plate_purposes'
  ...
  add_foreign_key 'product_product_catalogues',
                  'product_catalogues',
                  name: 'fk_product_product_catalogues_to_product_catalogues'
  ...
  add_foreign_key 'qc_reports',
                  'product_criteria',
                  column: 'product_criteria_id',
                  name: 'fk_qc_reports_to_product_criteria'
  ...
  add_foreign_key 'request_types_extended_validators',
                  'extended_validators',
                  name: 'fk_request_types_extended_validators_to_extended_validators'
  add_foreign_key 'request_types_extended_validators',
                  'request_types',
                  name: 'fk_request_types_extended_validators_to_request_types'
  ...
  add_foreign_key 'tag2_layout_template_submissions',
                  'submissions',
                  name: 'fk_tag2_layout_template_submissions_to_submissions'
  add_foreign_key 'tag2_layout_template_submissions',
                  'tag2_layout_templates',
                  name: 'fk_tag2_layout_template_submissions_to_tag2_layout_templates'
