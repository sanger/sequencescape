...
[{ name: 'Illumina-C - Cherrypick Internally',
 ...
 { name: 'Pulldown WGS - Single ended sequencing',
   ...
   submission_parameters: { info_differential: 5,
                            ...
                            request_types: %w[pulldown_wgs illumina_a_single_ended_sequencing] } },
 { name: 'Pulldown WGS - Single ended hi seq sequencing',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   submission_parameters: { info_differential: 5,
                            request_options: { 'fragment_size_required_to' => '400', 'fragment_size_required_from' => '100' },
                            request_types: %w[pulldown_wgs illumina_a_single_ended_hi_seq_sequencing] } },
 { name: 'Pulldown WGS - Paired end sequencing',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   submission_parameters: { info_differential: 5,
                            request_options: { 'fragment_size_required_to' => '400', 'fragment_size_required_from' => '100' },
                            request_types: %w[pulldown_wgs illumina_a_paired_end_sequencing] } },
 ...
 { name: 'Pulldown SC - Single ended sequencing',
   ...
   product_catalogue: 'Generic',
   submission_parameters: { info_differential: 5,
                            request_types: %w[pulldown_sc illumina_a_single_ended_sequencing],
 ...
 { name: 'Pulldown SC - Single ended hi seq sequencing',
   ...
   product_catalogue: 'Generic',
   submission_parameters: { info_differential: 5,
                            request_types: %w[pulldown_sc illumina_a_single_ended_hi_seq_sequencing],
                            request_options: { 'fragment_size_required_to' => '400', 'fragment_size_required_from' => '100', 'library_type' => 'Agilent Pulldown' } } },
 { name: 'Multiplexed PacBio',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   submission_parameters: { request_types: %w[pacbio_tagged_library_prep pacbio_multiplexed_sequencing] } },
 { name: 'Pulldown SC - Paired end sequencing',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   submission_parameters: { info_differential: 5,
                            request_types: %w[pulldown_sc illumina_a_paired_end_sequencing],
                            request_options: { 'fragment_size_required_to' => '400', 'fragment_size_required_from' => '100', 'library_type' => 'Agilent Pulldown' } } },
 ...
 { name: 'Pulldown SC - HiSeq Paired end sequencing',
   ...
   submission_parameters: { info_differential: 1,
                            ...
                            request_types: %w[pulldown_sc illumina_a_hiseq_paired_end_sequencing],
 ...
 { name: 'Pulldown ISC - Single ended sequencing',
   ...
   submission_parameters: { info_differential: 5,
                            request_options: { 'fragment_size_required_to' => '400', 'fragment_size_required_from' => '100', 'library_type' => 'Agilent Pulldown' },
                            request_types: %w[pulldown_isc illumina_a_single_ended_sequencing] } },
 { name: 'Pulldown ISC - Single ended hi seq sequencing',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   submission_parameters: { info_differential: 5,
                            request_types: %w[pulldown_isc illumina_a_single_ended_hi_seq_sequencing] } },
 { name: 'Pulldown ISC - Paired end sequencing',
   ...
   submission_parameters: { info_differential: 5,
                            ...
                            request_types: %w[pulldown_isc illumina_a_paired_end_sequencing] } },
 ...
 { name: 'Library creation - Single ended sequencing',
   ...
   submission_parameters: { info_differential: 5,
                            request_types: %w[library_creation single_ended_sequencing] } },
 { name: 'Library creation - Single ended hi seq sequencing',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   superceded_at: 'Mon Oct 05 15:58:50 UTC 2015',
   submission_parameters: { info_differential: 5,
                            request_types: %w[library_creation single_ended_hi_seq_sequencing] } },
 ...
 { name: 'Library creation - HiSeq Paired end sequencing',
   ...
   superceded_at: 'Mon Oct 05 15:58:50 UTC 2015',
   submission_parameters: { info_differential: 5,
                            request_types: %w[library_creation hiseq_paired_end_sequencing] } },
 { name: 'Multiplexed library creation - Single ended sequencing',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   superceded_at: 'Mon Oct 05 15:58:50 UTC 2015',
   submission_parameters: { info_differential: 5,
                            request_types: %w[multiplexed_library_creation single_ended_sequencing] } },
 { name: 'Multiplexed library creation - Single ended hi seq sequencing',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   superceded_at: 'Mon Oct 05 15:58:50 UTC 2015',
   submission_parameters: { info_differential: 5,
                            request_types: %w[multiplexed_library_creation single_ended_hi_seq_sequencing] } },
 { name: 'Multiplexed library creation - Paired end sequencing',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   superceded_at: 'Mon Oct 05 15:58:50 UTC 2015',
   submission_parameters: { info_differential: 5,
                            request_types: %w[multiplexed_library_creation paired_end_sequencing] } },
 { name: 'Multiplexed library creation - HiSeq Paired end sequencing',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   superceded_at: 'Mon Oct 05 15:58:50 UTC 2015',
   submission_parameters: { info_differential: 5,
                            request_types: %w[multiplexed_library_creation hiseq_paired_end_sequencing] } },
 { name: 'Multiplexed library creation - Cherrypick',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   submission_parameters: { info_differential: 5,
                            request_types: %w[multiplexed_library_creation illumina_c_cherrypick] } },
 { name: 'Pulldown library creation - Single ended sequencing',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   superceded_at: 'Mon Oct 05 15:58:50 UTC 2015',
   submission_parameters: { info_differential: 5,
                            request_types: %w[pulldown_library_creation single_ended_sequencing] } },
 { name: 'Pulldown library creation - Single ended hi seq sequencing',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   superceded_at: 'Mon Oct 05 15:58:50 UTC 2015',
   submission_parameters: { info_differential: 5,
                            request_types: %w[pulldown_library_creation single_ended_hi_seq_sequencing] } },
 { name: 'Pulldown library creation - Paired end sequencing',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   superceded_at: 'Mon Oct 05 15:58:50 UTC 2015',
   submission_parameters: { info_differential: 5,
                            request_types: %w[pulldown_library_creation paired_end_sequencing] } },
 { name: 'Pulldown library creation - HiSeq Paired end sequencing',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   superceded_at: 'Mon Oct 05 15:58:50 UTC 2015',
   submission_parameters: { info_differential: 5,
                            request_types: %w[pulldown_library_creation hiseq_paired_end_sequencing] } },
 { name: 'Pulldown Multiplex Library Preparation - Single ended sequencing',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   superceded_at: 'Mon Oct 05 15:58:50 UTC 2015',
   submission_parameters: { info_differential: 5,
                            request_types: %w[pulldown_multiplexing single_ended_sequencing] } },
 { name: 'Pulldown Multiplex Library Preparation - Single ended hi seq sequencing',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   superceded_at: 'Mon Oct 05 15:58:50 UTC 2015',
   submission_parameters: { info_differential: 5,
                            request_types: %w[pulldown_multiplexing single_ended_hi_seq_sequencing] } },
 { name: 'Pulldown Multiplex Library Preparation - Paired end sequencing',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   superceded_at: 'Mon Oct 05 15:58:51 UTC 2015',
   submission_parameters: { info_differential: 5,
                            request_types: %w[pulldown_multiplexing paired_end_sequencing] } },
 { name: 'Pulldown Multiplex Library Preparation - HiSeq Paired end sequencing',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   superceded_at: 'Mon Oct 05 15:58:51 UTC 2015',
   submission_parameters: { info_differential: 5,
                            request_types: %w[pulldown_multiplexing hiseq_paired_end_sequencing] } },
 { name: 'Pulldown Multiplex Library Preparation - Cherrypick',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   submission_parameters: { info_differential: 5,
                            request_types: %w[pulldown_multiplexing illumina_c_cherrypick] } },
 { name: 'PacBio Library Prep - Single ended sequencing',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   superceded_at: 'Mon Oct 05 15:58:51 UTC 2015',
   submission_parameters: { info_differential: 5,
                            request_types: %w[pacbio_sample_prep single_ended_sequencing] } },
 { name: 'PacBio Library Prep - Single ended hi seq sequencing',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   superceded_at: 'Mon Oct 05 15:58:51 UTC 2015',
   submission_parameters: { info_differential: 5,
                            request_types: %w[pacbio_sample_prep single_ended_hi_seq_sequencing] } },
 { name: 'PacBio Library Prep - Paired end sequencing',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   superceded_at: 'Mon Oct 05 15:58:51 UTC 2015',
   submission_parameters: { info_differential: 5,
                            request_types: %w[pacbio_sample_prep paired_end_sequencing] } },
 { name: 'PacBio Library Prep - HiSeq Paired end sequencing',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   superceded_at: 'Mon Oct 05 15:58:51 UTC 2015',
   submission_parameters: { info_differential: 5,
                            request_types: %w[pacbio_sample_prep hiseq_paired_end_sequencing] } },
 { name: 'PacBio Library Prep - Cherrypick',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   submission_parameters: { info_differential: 5,
                            request_types: %w[pacbio_sample_prep illumina_c_cherrypick] } },
 { name: 'PacBio Sequencing - Single ended sequencing',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   superceded_at: 'Mon Oct 05 15:58:51 UTC 2015',
   submission_parameters: { info_differential: 5,
                            request_types: %w[pacbio_sequencing single_ended_sequencing] } },
 { name: 'PacBio Sequencing - Single ended hi seq sequencing',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   superceded_at: 'Mon Oct 05 15:58:51 UTC 2015',
   submission_parameters: { info_differential: 5,
                            request_types: %w[pacbio_sequencing single_ended_hi_seq_sequencing] } },
 { name: 'PacBio Sequencing - Paired end sequencing',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   superceded_at: 'Mon Oct 05 15:58:51 UTC 2015',
   submission_parameters: { info_differential: 5,
                            request_types: %w[pacbio_sequencing paired_end_sequencing] } },
 { name: 'PacBio Sequencing - HiSeq Paired end sequencing',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   superceded_at: 'Mon Oct 05 15:58:51 UTC 2015',
   submission_parameters: { info_differential: 5,
                            request_types: %w[pacbio_sequencing hiseq_paired_end_sequencing] } },
 { name: 'PacBio Sequencing - Cherrypick',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   submission_parameters: { info_differential: 5,
                            request_types: %w[pacbio_sequencing illumina_c_cherrypick] } },
 { name: 'Pulldown WGS - Cherrypick',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   submission_parameters: { info_differential: 5,
                            request_types: %w[pulldown_wgs illumina_c_cherrypick] } },
 { name: 'Pulldown SC - Cherrypick',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   submission_parameters: { info_differential: 5,
                            request_types: %w[pulldown_sc illumina_c_cherrypick] } },
 { name: 'Pulldown ISC - Cherrypick',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   submission_parameters: { info_differential: 5,
                            request_types: %w[pulldown_isc illumina_c_cherrypick] } },
 { name: 'MiSeq sequencing - Single ended sequencing',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   superceded_at: 'Mon Oct 05 15:58:51 UTC 2015',
   submission_parameters: { info_differential: 5,
                            request_types: %w[miseq_sequencing single_ended_sequencing] } },
 { name: 'MiSeq sequencing - Single ended hi seq sequencing',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   superceded_at: 'Mon Oct 05 15:58:51 UTC 2015',
   submission_parameters: { info_differential: 5,
                            request_types: %w[miseq_sequencing single_ended_hi_seq_sequencing] } },
 { name: 'MiSeq sequencing - Paired end sequencing',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   superceded_at: 'Mon Oct 05 15:58:51 UTC 2015',
   submission_parameters: { info_differential: 5,
                            request_types: %w[miseq_sequencing paired_end_sequencing] } },
 { name: 'MiSeq sequencing - HiSeq Paired end sequencing',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   superceded_at: 'Mon Oct 05 15:58:51 UTC 2015',
   submission_parameters: { info_differential: 5,
                            request_types: %w[miseq_sequencing hiseq_paired_end_sequencing] } },
 { name: 'MiSeq sequencing - Cherrypick',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   submission_parameters: { info_differential: 5,
                            request_types: %w[miseq_sequencing illumina_c_cherrypick] } },
 { name: 'Illumina-C - Library creation - Single ended sequencing',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   submission_parameters: { info_differential: 5,
                            request_types: %w[illumina_c_library_creation illumina_c_single_ended_sequencing] } },
 ...
 { name: 'Illumina-C - Library creation - HiSeq Paired end sequencing',
   ...
   product_catalogue: 'Generic',
   submission_parameters: { info_differential: 5,
                            request_types: %w[illumina_c_library_creation illumina_c_hiseq_paired_end_sequencing] } },
 ...
 { name: 'Illumina-B - Multiplexed Library Creation - Single ended sequencing',
   ...
   submission_parameters: { info_differential: 5,
                            request_types: %w[illumina_b_multiplexed_library_creation
 ...
 { name: 'Illumina-B - Multiplexed WGS - Single ended sequencing',
   ...
   superceeded_by_id: -2,
   submission_parameters: { info_differential: 5,
                            request_types: %w[illumina_b_std illumina_b_single_ended_sequencing] } },
 { name: 'Illumina-B - Multiplexed WGS - Single ended hi seq sequencing',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   superceeded_by_id: -2,
   submission_parameters: { info_differential: 5,
                            request_types: %w[illumina_b_std illumina_b_single_ended_hi_seq_sequencing] } },
 { name: 'Illumina-B - Multiplexed WGS - Paired end sequencing',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   superceeded_by_id: -2,
   submission_parameters: { info_differential: 5,
                            request_types: %w[illumina_b_std illumina_b_paired_end_sequencing] } },
 { name: 'Illumina-B - Multiplexed WGS - HiSeq 2500 Paired end sequencing',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   superceeded_by_id: -2,
   submission_parameters: { info_differential: 5,
                            request_types: %w[illumina_b_std illumina_b_hiseq_2500_paired_end_sequencing] } },
 { name: 'Illumina-B - Multiplexed WGS - HiSeq 2500 Single end sequencing',
   submission_class_name: 'LinearSubmission',
   product_catalogue: 'Generic',
   superceeded_by_id: -2,
   submission_parameters: { info_differential: 5,
                            request_types: %w[illumina_b_std illumina_b_hiseq_2500_single_end_sequencing] } },
 ...
 { name: 'Illumina-A - HTP ISC - Single ended sequencing',
   ...
   superceeded_by_id: -2,
   submission_parameters: { info_differential: 5,
                            request_types: %w[illumina_a_shared
                                              illumina_a_isc
 ...
 { name: 'Illumina-A - Pulldown SC - HiSeq v4 sequencing',
   ...
   superceeded_by_id: -2,
   product_catalogue: 'Generic',
   submission_parameters: { request_types: %w[illumina_a_pulldown_sc illumina_a_hiseq_v4_paired_end_sequencing] } },
 { name: 'Illumina-A - Pulldown ISC - HiSeq v4 sequencing',
   submission_class_name: 'LinearSubmission',
   product_line: 'Illumina-A',
   superceeded_by_id: -2,
   product_catalogue: 'Generic',
   submission_parameters: { request_types: %w[illumina_a_pulldown_isc illumina_a_hiseq_v4_paired_end_sequencing] } },
 { name: 'Illumina-A - Pooled - HiSeq v4 sequencing',
   submission_class_name: 'LinearSubmission',
   product_line: 'Illumina-A',
   superceeded_by_id: -2,
   product_catalogue: 'Generic',
   submission_parameters: { request_types: %w[illumina_a_shared
                                              illumina_a_pool
 ...
 { name: 'Illumina-A - HTP ISC - HiSeq v4 sequencing',
   ...
   superceeded_by_id: -2,
   product_catalogue: 'Generic',
   submission_parameters: { request_types: %w[illumina_a_isc illumina_a_hiseq_v4_paired_end_sequencing] } },
 { name: 'ISC Repool - HiSeq Paired end sequencing',
   submission_class_name: 'LinearSubmission',
   product_line: 'Illumina-A',
   product_catalogue: 'Generic',
   superceeded_by_id: -2,
   submission_parameters: { request_types: %w[illumina_a_re_isc illumina_a_hiseq_paired_end_sequencing],
                            order_role: 'ReISC' } },
 { name: 'ISC Repool - Single ended hi seq sequencing',
   ...
   product_catalogue: 'Generic',
   superceeded_by_id: -2,
   submission_parameters: { request_types: %w[illumina_a_re_isc illumina_a_single_ended_hi_seq_sequencing],
                            order_role: 'ReISC' } },
 { name: 'ISC Repool - HiSeq 2500 Paired end sequencing',
   ...
   product_catalogue: 'Generic',
   superceeded_by_id: -2,
   submission_parameters: { request_types: %w[illumina_a_re_isc illumina_a_hiseq_2500_paired_end_sequencing],
                            order_role: 'ReISC' } },
 { name: 'ISC Repool - HiSeq 2500 Single end sequencing',
   ...
   product_catalogue: 'Generic',
   superceeded_by_id: -2,
   submission_parameters: { request_types: %w[illumina_a_re_isc illumina_a_hiseq_2500_single_end_sequencing],
                            order_role: 'ReISC' } },
 { name: 'ISC Repool - MiSeq sequencing',
   ...
   product_catalogue: 'Generic',
   superceeded_by_id: -2,
   submission_parameters: { request_types: %w[illumina_a_re_isc illumina_a_miseq_sequencing],
                            order_role: 'ReISC' } },
 { name: 'ISC Repool - HiSeq V4 Paired end sequencing',
   ...
   product_catalogue: 'Generic',
   superceeded_by_id: -2,
   submission_parameters: { request_types: %w[illumina_a_re_isc illumina_a_hiseq_v4_paired_end_sequencing],
                            order_role: 'ReISC' } },
 { name: 'ISC Repool - HiSeq X Paired end sequencing',
   ...
   product_catalogue: 'Generic',
   superceeded_by_id: -2,
   submission_parameters: { request_types: %w[illumina_a_re_isc illumina_a_hiseq_x_paired_end_sequencing],
                            order_role: 'ReISC' } },
 { name: 'Illumina-A - Pulldown WGS - HiSeq v4 sequencing',
   ...
   superceeded_by_id: -2,
   product_catalogue: 'Generic',
   submission_parameters: { request_types: %w[illumina_a_pulldown_wgs illumina_a_hiseq_v4_paired_end_sequencing] } },
 { name: 'Illumina-B - Multiplexed WGS - HiSeq v4 sequencing',
   submission_class_name: 'LinearSubmission',
   product_line: 'Illumina-B',
   superceeded_by_id: -2,
   product_catalogue: 'Generic',
   submission_parameters: { request_types: %w[illumina_b_std illumina_b_hiseq_v4_paired_end_sequencing] } },
 ...
 { name: 'HiSeq-X library re-sequencing',
   ...
   product_line: 'Illumina-B',
   product_catalogue: 'Generic',
   submission_parameters: { request_types: %w[illumina_htp_strip_tube_creation hiseq_x_paired_end_sequencing],
                            order_role: 'HSqX' } },
 { name: 'Illumina-C - General PCR - HiSeq v4 sequencing',
   ...
   submission_parameters: { request_types: %w[illumina_c_pcr illumina_c_hiseq_v4_paired_end_sequencing] } },
 { name: 'Illumina-C - General no PCR - HiSeq v4 sequencing',
   ...
   superceded_at: 'Mon Oct 05 15:59:05 UTC 2015',
   submission_parameters: { request_types:      %w[illumina_c_nopcr illumina_c_hiseq_v4_paired_end_sequencing] } },
 { name: 'Illumina-C - Library Creation - HiSeq v4 sequencing',
   ...
   superceded_at: 'Mon Oct 05 15:59:05 UTC 2015',
   submission_parameters: { request_types: %w[illumina_c_library_creation
                                              illumina_c_hiseq_v4_paired_end_sequencing] } },
 { name: 'Illumina-C - Multiplexed Library Creation - HiSeq v4 sequencing',
   ...
   superceded_at: 'Mon Oct 05 15:59:05 UTC 2015',
   submission_parameters: { request_types: %w[illumina_c_multiplexed_library_creation
                                              illumina_c_hiseq_v4_paired_end_sequencing] } },
 { name: 'Illumina-C - General PCR - HiSeq v4 sequencing SE',
   submission_class_name: 'LinearSubmission',
   product_line: 'Illumina-C',
   product_catalogue: 'Generic',
   submission_parameters: { request_types: %w[illumina_c_pcr illumina_c_hiseq_v4_single_end_sequencing] } },
 ...
 { name: 'Illumina-C - General no PCR - HiSeq v4 sequencing SE',
   ...
   product_line: 'Illumina-C',
   product_catalogue: 'Generic',
   submission_parameters: { request_types: %w[illumina_c_nopcr illumina_c_hiseq_v4_single_end_sequencing] } },
 ...
 { name: 'Illumina-C - General PCR - HiSeq-X sequencing',
   ...
   product_line: 'Illumina-C',
   product_catalogue: 'Generic',
   submission_parameters: { request_types: %w[illumina_c_pcr bespoke_hiseq_x_paired_end_sequencing] } },
 { name: 'Illumina-C - General no PCR - HiSeq-X sequencing',
   submission_class_name: 'LinearSubmission',
   product_line: 'Illumina-C',
   product_catalogue: 'Generic',
   submission_parameters: { request_types: %w[illumina_c_nopcr bespoke_hiseq_x_paired_end_sequencing] } },
 ...
 { name: 'Illumina-C Multiplex - Single ended hi seq sequencing',
   ...
   product_catalogue: 'Generic',
   submission_parameters: { info_differential: 5,
                            request_types: %w[illumina_c_multiplexing illumina_c_single_ended_hi_seq_sequencing],
                            order_role: 'PCR' } },
 ...
 { name: 'Illumina-C Multiplex - HiSeq 2500 Paired end sequencing',
   ...
   product_catalogue: 'Generic',
   submission_parameters: { info_differential: 5,
                            request_types: %w[illumina_c_multiplexing
                                              illumina_c_hiseq_2500_paired_end_sequencing],
                            order_role: 'PCR' } },
