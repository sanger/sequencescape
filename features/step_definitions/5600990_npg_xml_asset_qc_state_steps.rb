Given /^sequencescape is setup for 5600990$/ do
 ...
 request = Factory :sequencing_request, :asset => library_tube, :target_asset => lane, :state => 'started'
...
Given /^a second request$/ do
 ...
 library_tube = Factory :empty_library_tube
 request = Factory :sequencing_request, :asset => library_tube, :target_asset => lane
end
