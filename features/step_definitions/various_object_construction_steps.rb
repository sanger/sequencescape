Given /^(?:a|the) (project|study|sample|sample tube|library tube|well|plate|lane|pulldown multiplexed library tube|multiplexed library tube|faculty sponsor) (?:named|called) "([^\"]+)" exists$/ do |type,name|
