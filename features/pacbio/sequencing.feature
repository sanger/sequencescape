...
Feature: Push samples through the PacBio pipeline for sequencing
  ...
  Scenario: Default layout of tubes on a plate
   ...
   Then the PacBio manifest for the last batch should look like:
     ...
     | A01      | Sample_111  | 999                               |  777                     | UsedControl=true       | Standard Seq 2-Set v1 | AcquisitionTime=12\|InsertSize=250\|NumberOfCollections=1 | Default    | 00000000-1111-2222-3333-444444444441 | 00000000-1111-2222-3333-444444444443 | 00000000-1111-2222-3333-444444444445 | 99999        | 00000000-1111-2222-3333-000000000002 |
