...
Feature: The Tecan file has the wrong buffer volumes, defaulting to 13 total volume
  ...
  Scenario: volume of 65 is required
    ...
    Given plate "1220000010734" has concentration and high volume results
    Given plate "1220000001831" has concentration and high volume results
    Given plate "1220000005877" has concentration and high volume results
