...
Feature: Access tag layouts through the API
  ...
  Scenario: Reading the JSON for a UUID
    Given the tag layout exists with ID 1
      ...
      And the tag group for tag layout with ID 1 is called "Test Tag group"
  ...
  Scenario: Creating a tag layout of an entire plate using 96 tags by pools
    ...
    Given the tag group "Test Tag group" exists
      And the UUID for the tag group "Test Tag group" is "00000000-1111-2222-3333-444444444444"
      And the tag group "Test Tag group" has 20 tags
  ...
  Scenario: Creating a tag layout of an entire plate using 96 tags by pools
    ...
    Given the tag group "Test Tag group" exists
      And the UUID for the tag group "Test Tag group" is "00000000-1111-2222-3333-444444444444"
      And the tag group "Test Tag group" has 96 tags
  ...
  Scenario: Creating a tag layout of an entire plate using 96 tags by pools with an offset
    ...
    Given the tag group "Test Tag group" exists
      And the UUID for the tag group "Test Tag group" is "00000000-1111-2222-3333-444444444444"
      And the tag group "Test Tag group" has 30 tags
  ...
  Scenario: Creating a tag layout of an entire plate using 96 tags by pools with an offset
    ...
    Given the tag group "Test Tag group" exists
      And the UUID for the tag group "Test Tag group" is "00000000-1111-2222-3333-444444444444"
      And the tag group "Test Tag group" has 106 tags
