    ...
    And the JSON should match the following for the specified fields:
      """
      {
        "sample_manifest": {
          ...
          "samples": [
            { "sample": { "sanger": { "sample_id": "WTCCC01" } }, "container":{ "position": "A01", "barcode": "DN1234567T" } },
            { "sample": { "sanger": { "sample_id": "WTCCC02" } }, "container":{ "position": "B01", "barcode": "DN1234567T" } },
            { "sample": { "sanger": { "sample_id": "WTCCC03" } }, "container":{ "position": "C01", "barcode": "DN1234567T" } },
            { "sample": { "sanger": { "sample_id": "WTCCC04" } }, "container":{ "position": "D01", "barcode": "DN1234567T" } },
            { "sample": { "sanger": { "sample_id": "WTCCC05" } }, "container":{ "position": "E01", "barcode": "DN1234567T" } },
            { "sample": { "sanger": { "sample_id": "WTCCC06" } }, "container":{ "position": "F01", "barcode": "DN1234567T" } },
            { "sample": { "sanger": { "sample_id": "WTCCC07" } }, "container":{ "position": "G01", "barcode": "DN1234567T" } },
            { "sample": { "sanger": { "sample_id": "WTCCC08" } }, "container":{ "position": "H01", "barcode": "DN1234567T" } },
            { "sample": { "sanger": { "sample_id": "WTCCC09" } }, "container":{ "position": "A02", "barcode": "DN1234567T" } },
