...
Feature: Searching for users by swipcard code
  Background:
    ...
    Given the UUID for the search "Find user by swipcard code" is "00000000-1111-2222-3333-444444444444"

  @single
    Scenario: looking for an existing user by swipcard code
