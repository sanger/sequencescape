...
And I have a "full" authorised user with the key "cucumber"
  ...
  Scenario: Creating a Qc Decisions
    ...
    When I make an authorised POST with the following JSON to the API path "/qc_decisions":
      """
      {
        "qc_decision": {
          ...
          "decisions": [
            {"qcable":"55555555-6666-7777-8888-000000000011","decision":"release"},
            {"qcable":"55555555-6666-7777-8888-000000000012","decision":"release"}
          ]
        }
      }
      """
    ...
    And the JSON should match the following for the specified fields:
      ...
      """
   And the qcables in lot "1234567890" should be "available"
