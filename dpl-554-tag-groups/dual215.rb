...
CSV_FILE_PATH = '000 10x Tagsets - PN-1000215_PN-3000431_ Dual Index Kit TT, Set A.csv'
...
names = {
  1 => 'Dual Index Kit TT, Set A 1000215 i7',
  2 => 'Dual Index Kit TT, Set A 1000215 i5 (Workflow A)',
  3 => 'Dual Index Kit TT, Set A 1000215 i5 (Workflow B)'
}
