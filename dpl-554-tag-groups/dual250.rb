...
CSV_FILE_PATH = '000 10x Tagsets - PN-1000250_ Dual Index Kit TN, Set A.csv'
...
names = {
  1 => 'Dual Index Kit TN, Set A 1000250 i7',
  2 => 'Dual Index Kit TN, Set A 1000250 i5 (Workflow A)',
  3 => 'Dual Index Kit TN, Set A 1000250 i5 (Workflow B)'
}
