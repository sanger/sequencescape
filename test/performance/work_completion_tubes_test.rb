...
class WorkCompletionTubesTest < ActionDispatch::PerformanceTest
  ...
  def setup
    ...
    target_submission_1 = create :library_submission, assets: input_plate_1.wells, request_types: submission_request_types
    target_submission_2 = create :library_submission, assets: input_plate_2.wells, request_types: submission_request_types
    target_submission_3 = create :library_submission, assets: input_plate_3.wells, request_types: submission_request_types
    target_submission_4 = create :library_submission, assets: input_plate_4.wells, request_types: submission_request_types
    ...
    input_plate_1.wells.each do |well|
      ...
      create :library_request, request_type: library_request_type, asset: well, submission: target_submission_1, state: 'started'
    ...
    input_plate_2.wells.each do |well|
      ...
      create :library_request, request_type: library_request_type, asset: well, submission: target_submission_2, state: 'started'
    end
    input_plate_3.wells.each do |well|
      next if well.aliquots.empty?

      create :library_request, request_type: library_request_type, asset: well, submission: target_submission_3, state: 'started'
    end
    input_plate_4.wells.each do |well|
      next if well.aliquots.empty?

      create :library_request, request_type: library_request_type, asset: well, submission: target_submission_4, state: 'started'
    end
    ...
    target_plate_1 = create :target_plate, parent: input_plate_1, well_count: tested_wells, submission: target_submission_1
    target_plate_2 = create :target_plate, parent: input_plate_2, well_count: tested_wells, submission: target_submission_2
    target_plate_3 = create :target_plate, parent: input_plate_3, well_count: tested_wells, submission: target_submission_3
    target_plate_4 = create :target_plate, parent: input_plate_4, well_count: tested_wells, submission: target_submission_4
    ...
    target_plate_3.wells.each do |well|
      create :transfer_request, asset: well, target_asset: tube_3
    end

    tube_4 = create :new_stock_multiplexed_library_tube, parents: [target_plate_4]

    target_plate_4.wells.each do |well|
      create :transfer_request, asset: well, target_asset: tube_4
    end

    thirds = [tube_1_2, tube_3, tube_4].map do |start|
    ...
    thirds.each do |third|
      create :transfer_request, asset: third, target_asset: @target_tube
    end
  end
