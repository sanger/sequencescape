...
class ProductCriteriaBasicTest < ActiveSupport::TestCase
  ...
  context "a configured criteria" do
    ...
    context "with a bad well" do
      setup do
        @well_attribute = create :well_attribute, :concentration => 1, :measured_volume => 30000, :gel_pass => 'OKAY', :gender_markers => ["M", "M", "U"]
    ...
    context "with a good well" do
      setup do
        @well_attribute = create :well_attribute, :concentration => 800, :measured_volume => 100, :gel_pass => 'OKAY', :gender_markers => ["M", "M", "U"]
        @well = create :well, :well_attribute => @well_attribute
