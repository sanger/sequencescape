...
class SampleManifestUploadProcessorTubeRackTest < ActiveSupport::TestCase
  ...
  test 'validates coordinates' do
    ...
    proc = SampleManifestExcel::Upload::Processor::TubeRack.new(SampleManifestExcel::Upload::Base.new) # TODO: Difficulty with initialising - need to pass a file & maybe other things
