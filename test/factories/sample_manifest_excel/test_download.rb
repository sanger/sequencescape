FactoryGirl.define do
  factory :test_download, class: SampleManifestExcel::TestDownload do
    ...
    data {
      { prepooled: 'No', library_type: 'My personal library type', insert_size_from: 200, insert_size_to: 1500,
    ...
    initialize_with {
      new(data: data, columns: columns, validation_errors: validation_errors, no_of_rows: no_of_rows,
