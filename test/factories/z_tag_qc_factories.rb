...
Factory.define :index_tag_lot_type, :parent=> :lot_type do |lot_type|
  lot_type.name           { Factory.next :lot_type_name }
...
Factory.define :index_tag_lot, :parent => :lot do |lot|
  lot.lot_number  { Factory.next :lot_number }
  lot.lot_type    { Factory :index_tag_lot_type }
  lot.template    { Factory :index_tag_layout_template }
  lot.user        { Factory :user }
  lot.received_at '2014-02-01'
end
