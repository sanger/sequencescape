...
Rails.root.glob('spec/factories/**/*.rb').each { |factory_filename| require factory_filename }

Rails.root.glob('test/shoulda_macros/*.rb').each { |macro_filename| require macro_filename }
