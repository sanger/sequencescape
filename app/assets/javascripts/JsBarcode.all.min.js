...
!(function (t) {
  ...
  function (t, e, n) {
    ...
    (e.MODULO = 103),
      ...
      (e.C_CHARS = "(Ï*[0-9]{2}Ï*)"),
      (e.BARS = [
        11011001100, 11001101100, 11001100110, 10010011e3, 10010001100, 10001001100, 10011001e3, 10011000100,
        10001100100, 11001001e3, 11001000100, 11000100100, 10110011100, 10011011100, 10011001110, 10111001100,
        10011101100, 10011100110, 11001110010, 11001011100, 11001001110, 11011100100, 11001110100, 11101101110,
        11101001100, 11100101100, 11100100110, 11101100100, 11100110100, 11100110010, 11011011e3, 11011000110,
        11000110110, 10100011e3, 10001011e3, 10001000110, 10110001e3, 10001101e3, 10001100010, 11010001e3, 11000101e3,
        11000100010, 10110111e3, 10110001110, 10001101110, 10111011e3, 10111000110, 10001110110, 11101110110,
        11010001110, 11000101110, 11011101e3, 11011100010, 11011101110, 11101011e3, 11101000110, 11100010110,
        11101101e3, 11101100010, 11100011010, 11101111010, 11001000010, 11110001010, 1010011e4, 10100001100, 1001011e4,
        10010000110, 10000101100, 10000100110, 1011001e4, 10110000100, 1001101e4, 10011000010, 10000110100, 10000110010,
        11000010010, 1100101e4, 11110111010, 11000010100, 10001111010, 10100111100, 10010111100, 10010011110,
        10111100100, 10011110100, 10011110010, 11110100100, 11110010100, 11110010010, 11011011110, 11011110110,
        11110110110, 10101111e3, 10100011110, 10001011110, 10111101e3, 10111100010, 11110101e3, 11110100010,
                ...
                value: function (t, n, r) {
                  ...
                  if (t[0] >= 200) {
                    ...
                    void 0 !== a
                      ...
                      : ((r !== f.SET_A && r !== f.SET_B) ||
                          i !== f.SHIFT ||
                          (t[0] = r === f.SET_A ? (t[0] > 95 ? t[0] - 96 : t[0]) : t[0] < 32 ? t[0] + 96 : t[0]),
                        (o = e.next(t, n + 1, r)));
  ...
  function (t, e, n) {
    ...
    function r(t, e) {
      return (
        e.height + (e.displayValue && t.text.length > 0 ? e.fontSize + e.textMargin : 0) + e.marginTop + e.marginBottom
      );
    }
    function o(t, e, n) {
  ...
  function (t, e, n) {
    ...
    function o(t) {
      ...
      if ((t && "svg" === t.nodeName) || ("undefined" != typeof SVGElement && t instanceof SVGElement))
        return { element: t, options: (0, f.default)(t), renderer: l.default.SVGRenderer };
      if ("undefined" != typeof HTMLCanvasElement && t instanceof HTMLCanvasElement)
        return { element: t, options: (0, f.default)(t), renderer: l.default.CanvasRenderer };
  ...
  function (t, e, n) {
    ...
    var u = n(12),
      ...
      j = function (t, e, n) {
        ...
        return (
          ...
          void 0 !== e && ((n = n || {}), n.format || (n.format = i()), r.options(n)[n.format](e, n).render()),
          r
        );
      };
    ...
    for (var P in s.default)
      s.default.hasOwnProperty(P) &&
        (function (t, e) {
          x.prototype[e] =
    ...
    (x.prototype.options = function (t) {
      ...
      (x.prototype._defaults = m.default),
      ...
      l = (function (t) {
        function e(t, n) {
          if ((o(this, e), /^[\x00-\x7F\xC8-\xD3]+$/.test(t)))
            var r = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, (0, c.default)(t), n));
    ...
    var s = (function () {
      ...
      p = (function (t) {
        function e(t, n) {
          ...
          var r = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n));
          return (
            !n.flat && n.fontSize > 10 * n.width ? (r.fontSize = 10 * n.width) : (r.fontSize = n.fontSize),
            (r.guardHeight = n.height + r.fontSize / 2 + n.textMargin),
            (r.lastChar = n.lastChar),
            r
          );
        }
        return (
              ...
              value: function () {
                ...
                return (
                  ...
                  this.options.lastChar &&
                    this.options.displayValue &&
                    (e.push({ data: "00" }),
                    e.push({ data: "00000", text: this.options.lastChar, options: { fontSize: this.fontSize } })),
                  e
                );
              },
            },
    ...
    var u = (function () {
      ...
      d = (function (t) {
        function e(t, n) {
          ...
          var r = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n));
          return (
            (r.structure = ["GGLLL", "GLGLL", "GLLGL", "GLLLG", "LGGLL", "LLGGL", "LLLGG", "LGLGL", "LGLLG", "LLGLG"]),
            r
          );
        }
        return (
            ...
            },
            {
              ...
              value: function () {
                ...
                return (
                  ...
                  e.push({ data: "010101", options: { height: this.guardHeight } }),
                  this.displayValue &&
                    e.push({
                      data: "00000000",
                      text: this.text[7],
        ...
        return (
          ...
          a(e, [
            ...
            },
            {
              ...
              value: function (t) {
                for (
                  var e = "", n = this.binaryRepresentation[t[0]], r = this.binaryRepresentation[t[1]], o = 0;
                  o < 5;
                  o++
                )
              ...
              value: function () {
                ...
                (this.canvas.width = e + this.options.marginLeft + this.options.marginRight),
                  ...
                  this.options.background &&
                    ((t.fillStyle = this.options.background), t.fillRect(0, 0, this.canvas.width, this.canvas.height)),
            ...
            },
            {
              ...
              value: function () {
                ...
                this.setSvgAttributes(n, e),
                  this.options.background &&
                    this.drawRect(0, 0, n, e, this.svg).setAttribute("style", "fill:" + this.options.background + ";");
              },
            },
            {
              key: "drawSvgBarcode",
