  ...
  module V2
    module Sapio
      ...
      class StudyMetadataResource < Api::V2::StudyMetadataResource
        ...
        #     study metadata.
        has_one :study_type, class_name: 'StudyType', foreign_key_on: :self, readonly: true
        ...
        has_one :data_release_study_type, class_name: 'DataReleaseStudyType', foreign_key_on: :self, readonly: true

        # @!attribute [r] reference_genome
        #   @return [ReferenceGenomeResource, nil] The reference genome
        #     associated with this study metadata.
        has_one :reference_genome, class_name: 'ReferenceGenome', foreign_key_on: :self, readonly: true

        # @!attribute [r] program
        #   @return [ProgramResource, nil] The program associated with this
        #     study metadata.
        has_one :program, class_name: 'Program', foreign_key_on: :self, readonly: true
        ...
        #   @example Jane Doe
        attribute :old_sac_sponsor, readonly: true

        # @!attribute [r] study_description
        #   @return [String, nil] Study description.
        attribute :study_description, readonly: true
        ...
        attribute :data_release_timing, readonly: true

        # @!attribute [r] data_release_delay_reason
        #   @return [String, nil] Reason for delaying release.
        #   @example 'PhD Study'
        attribute :data_release_delay_reason, readonly: true
        ...
        attribute :data_release_delay_other_comment, readonly: true

        # @!attribute [r] data_release_delay_period
        #   @return [String, nil] Delay for.
        #   @example '18 months'
        attribute :data_release_delay_period, readonly: true
        ...
        attribute :data_release_delay_approval, readonly: true
        ...
        attribute :data_release_delay_reason_comment, readonly: true
        ...
        attribute :data_release_prevention_reason, readonly: true
        ...
        attribute :data_release_prevention_approval, readonly: true
