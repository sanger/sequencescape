...
module Api
  module V2
    ...
    #   {
    #     "data": {
    #       "type": "tube_from_plate_creations",
    #       "attributes": {
    ...
    #   }
    #
    # @example POST request with child purpose and parent plate specified by relationship
    #   POST /api/v2/tube_from_plate_creations/
    #   {
    #     "data": {
    #       "type": "tube_from_plate_creations",
    #       "attributes": {},
    ...
    class TubeFromPlateCreationResource < BaseResource
      ###
      # Attributes
      ###
