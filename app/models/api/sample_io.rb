...
class Api::SampleIO < Api::Base
  ...
  with_association(:sample_metadata) do
    ...
    map_attribute_to_json_attribute(:sample_extraction_method)
    map_attribute_to_json_attribute(:sample_purified)
    ...
    map_attribute_to_json_attribute(:sample_storage_conditions)
    ...
    map_attribute_to_json_attribute(:rnai)
